 ...
 * @author Claudio
 */
public class Seguridad_Privilegios extends javax.swing.JFrame {

    /**
     * Creates new form Clientes
     */

    public Seguridad_Privilegios() {
        initComponents();
 ...
 private void cambiarVentana(JFrame ventanaNueva) {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, -1, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel4.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 80, 220, 40));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 150, 420, 370));
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 483, 100, 50));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Seguridad_Privilegios().setVisible(true);
            }
        });
    }
