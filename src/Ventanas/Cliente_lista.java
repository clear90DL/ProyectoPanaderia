 ...
 * @author Claudio
 */
public class Cliente_lista extends javax.swing.JFrame {
 ...
 private void cambiarVentana(JFrame ventanaNueva) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre ", "Telefono", "Telefono adicional", "Dirección", "Tipo de cliente", "Correo"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 710, 280));
...
//        cambiarVentana(new Formas_de_pago());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cliente_lista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cliente_lista().setVisible(true);
            }
        });
    }
